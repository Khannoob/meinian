...
public class QiniuUtils {
    ...
    public  static String accessKey = "ZbAbx2QM6wkOBSbFCj0EzX8nk7kdFLSntQV8dqKT";
    public  static String secretKey = "AsyNuD4UloP-px0A_2AKh4Q96ebAVvC03VM38FTW";
    public  static String bucket = "test-meinian";
